        ...
        <MaxWidthWrapper className="text-center">
          <div className="relative mx-auto text-center flex flex-col items-center gap-10 ">
            ...
            <p className="text-base/7 text-gray-600 max-w-prose text-center text-pretty">
              Easiest way to monitor your SaaS. Get instant notification for{" "}
            ...
            {/* <ul className="space-y-2 text-base/7 text-gray-600 text-left flex flex-col items-start">
              {[
                ...
                return (
                  ...
                  >
                    <CheckCircleIcon className="size-5 shrink-0 text-brand-700" />
                    {item}
                  </li>
                )
              })}
      ...
      <section className="relative py-24 sm:py-32 bg-brand-25">
        <MaxWidthWrapper className="flex flex-col items-center gap-16 sm:gap-20">
          <div>
            ...
            <Heading>Stay ahead with realtime insights</Heading>
          </div>
            ...
            <div className="relative lg:row-span-2">
              ...
              <div className="relative flex h-full flex-col overflow-hidden rounded-[calc(theme(borderRadius.lg)+1px)] max-lg:rounded-b-[calc(2rem+1px)] lg:rounded-r-[calc(2rem+1px)]">
                ...
                <div className="relative min-h-[30rem] w-full grow">
                  <div className="absolute bottom-0 left-10 right-0 top-10 overflow-hidden rounded-tl-xl bg-gray-900 shadow-xl">
      ...
      <section className="relative py-24 sm:py-32">
        <MaxWidthWrapper className="flex flex-col items-center gap-16 sm:gap-20">
          <div>
            ...
            <Heading className="text-center">What our customer says</Heading>
          </div>
            ...
            <div className="flex flex-auto flex-col gap-4 bg-brand-25 p-6 sm:p-8 lg:p-16 rounded-b-[2rem] lg:rounded-bl-none lg:rounded-r-[2rem]">
              ...
              <div className="flex flex-col justify-center lg:justify-start sm:flex-row items-center sm:items-start gap-4 mt-2">
                ...
                <div className="flex flex-col items-center sm:items-start">
                  ...
                  <p className="text-sm text-gray-600">@patrickwho</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <ShinyButton
            href="/sign-up"
            className="relative z-10 h-14 w-full max-w-xs text-base shadow-lg transition-shadow duration-300 hover:shadow-xl capitalize"
          >
            Start for free today!
          </ShinyButton>
        </MaxWidthWrapper>
